...
- **Agent Observability** — Cloud Trace carries Google-generated spans for MCP tool calls and Model Armor evaluations traversing Agent Gateway; demonstrated end-to-end on 2026-08-31 (trace `442a845a56a86c50ee5d35be1891cdd7`); default configuration routes partner calls through the in-process simulator (`CASERELAY_PARTNER_MCP=0`)
