...
root_agent = Agent(
    ...
    instruction=(
        ...
        "education | verify_school_enrollment | child_name, dob, referral_id "
        "| ferpa_court_order\n"
        "health | check_appointment_status | appointment_status, "
        "provider_name, appointment_date | hipaa_signed_authorization\n"
        "legal | check_referral_status | case_reference, deadline | "
        "state_juvenile_court_order\n"
        "shelter | check_availability | referral_id, scheduling | "
        "state_juvenile_court_order\n"
        "family_services | check_assessment_schedule | assessment_scheduling | "
        "state_juvenile_court_order\n"
