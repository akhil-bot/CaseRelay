...
/**
 * Two products share one front door. Which one you get is a property of who you
 * are, so the choice is made before sign-in rather than toggled after it.
 */
      ...
      <div className={auth.column}>
        ...
        <main className="flex flex-1 items-center py-10">
          <div className={auth.form}>
            <h2 className={auth.title}>How do you sign in?</h2>
            <p className={cx("mt-1.5", auth.subtitle)}>
              The two views are separate products with separate access.
            </p>
